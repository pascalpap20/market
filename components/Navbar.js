...
export default function Navbar() {
  ...
  return (
    <div>
      ...
      <nav>
        <div
          className={`flex bg-primary shadow-md justify-between text-white items-center px-4 py-3 md:py-0`}
        >
          ...
          <div className={`hidden md:flex items-center`}>
            ...
            <Link passHref href={`https://wa.me/${process.env.NO_TELP}`}>
              <a target="_blank" className="block px-4 py-4 hover:bg-danger">
                Contact
              </a>
            </Link>
          </div>
